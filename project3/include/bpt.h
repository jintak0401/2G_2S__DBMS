...
typedef struct _page_t {
    ...
    char reserved[104];  // 16 ~ 120 영역 : 다음 과제를 위해 104 byte 잡아 놓음
...
int adjust_root(int table_id, header_t head, internal_t root, page_t page, page_t most_left_page);
...
void delete_entry(int table_id, header_t head, internal_t root, page_t page, pagenum_t* page_num, int64_t key , page_t most_left_page, page_t right_child);
