...
int adjust_root(header_t head, internal_t root, page_t page, page_t most_left_page);
...
void delete_entry(header_t head, internal_t root, page_t page, pagenum_t* page_num, int64_t key , page_t most_left_page, page_t right_child);
